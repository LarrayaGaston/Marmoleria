 ...
 * @author luca
 */
public class jDlg_CargarProveedor extends javax.swing.JDialog{
    ...
    public jDlg_CargarProveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        idPersona();
        idProveedor();
    ...
    Proveedor mProveedor = new Proveedor();
     ...
     gestionarPersona buscarP = new gestionarPersona();
...
//        txtfechaprueba.setEnabled(false);
        ...
        txt_apellido_proveedor.setEnabled(false);
        ...
        Guardar_proveedor.setEnabled(false);
...
//        txtfechaprueba.setEnabled(true);
        txt_Nombre_proveedor.setEnabled(true);
        txt_apellido_proveedor.setEnabled(true);
        ...
        Guardar_proveedor.setEnabled(true);
        Nuevo.setEnabled(true);
        Salir.setEnabled(true);
  ...
  void combocondIva(){
    ...
    void idProveedor(){
            ...
            String dato [] = new String [1];
            Conectar miconexion = new Conectar();
            String consultasql = "select max(idProveedor)+1 from proveedores";
            ResultSet rs = miconexion.consulta(consultasql);  
            ...
            while(rs.next()){       //recorre el resultset mientras tenga algun dato
                ...
                lblCodigoProveedor.setText(rs.getString(1));
                
                     
       // en caso de ser el primer articulo que vamos a cargar, se fija que la table este vacia y genera el 1
       //como id principal, en el caso contrario busca el ultimo y le suma 1
             if(rs.getString(1)==null){
             lblCodigoProveedor.setText("1");
            }
            else{
             /*
                 j=Integer.parseInt(c);
    ...
    private void initComponents() {
        ...
        txt_provCBU = new javax.swing.JTextField();
        ...
        txt_apellido_proveedor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_apellido_proveedorKeyPressed(evt);
            }
        });
        jPanel2.add(txt_apellido_proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 60, 160, -1));
        ...
        lblCodigoProveedor.setBackground(new java.awt.Color(255, 102, 204));
        lblCodigoProveedor.setForeground(new java.awt.Color(255, 255, 255));
        jPanel2.add(lblCodigoProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 54, 20));
        ...
        txt_Nombre_proveedor.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_Nombre_proveedorKeyPressed(evt);
            }
        });
        jPanel2.add(txt_Nombre_proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 157, -1));

        jdc_fechaNac.setDateFormatString("yyyy/MM/dd");
        jdc_fechaNac.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jdc_fechaNacMouseClicked(evt);
            }
        });
        jPanel2.add(jdc_fechaNac, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 90, 160, 30));
        ...
        txt_provCBU.setText("2850590940090418135201");
        txt_provCBU.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_provCBUKeyPressed(evt);
            }
        });
        jPanel2.add(txt_provCBU, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 310, 160, -1));
        ...
        Guardar_proveedor.setBackground(new java.awt.Color(255, 255, 255));
        Guardar_proveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos_Botones/x128-guardar_opt (1).png"))); // NOI18N
        Guardar_proveedor.setToolTipText("Guardar Proveedor");
        Guardar_proveedor.setBorderPainted(false);
        Guardar_proveedor.setContentAreaFilled(false);
        Guardar_proveedor.setFocusable(false);
        Guardar_proveedor.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos_Botones/x128-guardar_opt.png"))); // NOI18N
        Guardar_proveedor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                Guardar_proveedorMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                Guardar_proveedorMouseExited(evt);
            }
        });
        ...
        getContentPane().add(Guardar_proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 560, 110, 90));
    ...
    private void Guardar_proveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Guardar_proveedorActionPerformed
     // METODO GUARDAR
       gestionarProveedores guardar = new gestionarProveedores();
      ...
      if(txtDni.getText().isEmpty() )                                                                                                   //VALIDACIONES
       { 
        ...
        if(txt_Nombre_proveedor.getText().isEmpty() )                                                                                                   //VALIDACIONES
       { 
           JOptionPane.showMessageDialog(null,"Igrese NOMBRE ","Error: Datos Incompletos",JOptionPane.ERROR_MESSAGE);
      
       }
        
            if(txt_apellido_proveedor.getText().isEmpty() )                                                                                                   //VALIDACIONES
       { 
      ...
      mProveedor.setIdProveedor(Integer.parseInt(lblCodigoProveedor.getText()));
      miPersona.setNombre((txt_Nombre_proveedor.getText().toUpperCase()));
      miPersona.setApellido((txt_apellido_proveedor.getText().toUpperCase()));
      mProveedor.setProv_codPostal(Integer.parseInt(txtCodigopostal.getText()));
      miPersona.setDni(Integer.parseInt(txtDni.getText()));
      
      mProveedor.setProv_razonSocial(txtRazonSocial.getText().toUpperCase());
      mProveedor.setProv_direccion(txtDireccion.getText().toUpperCase());
      mProveedor.setProv_email(txtEmail.getText().toUpperCase());
      mProveedor.setProv_celular((txtCelular.getText()));
    
      mProveedor.setProv_telefono((txtTelefono.getText()));
      mProveedor.setProv_fax((txtFax.getText()));
      mProveedor.setProv_cuit((txtcuit.getText()));
     mProveedor.setProv_CBU(txt_provCBU.getText());
       
       mProveedor.setIdPersona(Integer.parseInt(lb_codPer.getText()));  
     ...
     /** String fecha;
      ...
      miPersona.setFechaNacimiento(fecha);*/
        ...
        miPersona.setFechaNacimiento(((JTextField)jdc_fechaNac.getDateEditor().getUiComponent()).getText());
    ...
    // METODO GUARDAR
             gestionarProveedores Modificarpro = new gestionarProveedores();
      ...
      miPersona.setIdPersona(Integer.parseInt(lb_codPer.getText()));
       ...
       Modificarpro.modificarProveedor(mProveedor);
       ModPersona.modificarPersona(miPersona);
      
       Mensajes.informacion("Proveedor Modificado");
         this.dispose();
        bloquear(); 
        limpiarCampos();
    ...
    private void txt_Nombre_proveedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_Nombre_proveedorKeyPressed

        validarCampos.soloLetras(txt_Nombre_proveedor);
    }//GEN-LAST:event_txt_Nombre_proveedorKeyPressed
    ...
    private void txt_apellido_proveedorKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_apellido_proveedorKeyPressed
        validarCampos.soloLetras(txt_apellido_proveedor);
    }//GEN-LAST:event_txt_apellido_proveedorKeyPressed
    ...
    private void txt_provCBUKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_provCBUKeyPressed
        validarCampos.soloNumeros(txt_provCBU);
    }//GEN-LAST:event_txt_provCBUKeyPressed

    private void Guardar_proveedorMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Guardar_proveedorMouseEntered

    }//GEN-LAST:event_Guardar_proveedorMouseEntered

    private void Guardar_proveedorMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Guardar_proveedorMouseExited

       
    }//GEN-LAST:event_Guardar_proveedorMouseExited
    ...
    private void jdc_fechaNacMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jdc_fechaNacMouseClicked

    }//GEN-LAST:event_jdc_fechaNacMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
           for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
            ...
            java.util.logging.Logger.getLogger(jDlg_CargarProveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                jDlg_CargarProveedor dialog = new jDlg_CargarProveedor(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JButton Guardar_proveedor;
    ...
    public static com.toedter.calendar.JDateChooser jdc_fechaNac;
    ...
    public static javax.swing.JTextField txt_Nombre_proveedor;
    public static javax.swing.JTextField txt_apellido_proveedor;
    public static javax.swing.JTextField txt_provCBU;
