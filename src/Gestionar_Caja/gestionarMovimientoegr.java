 ...
 */
public class gestionarMovimientoegr {
    ...
    public void GuardarMovimientoCajaing(MovimientoCaja micaja) {
        try {
            ...
            String sentenciaInsert= "Insert into movimiento_cajaegr (idegreso,detalle,monto,fecha) values (?,?,?,?)";
            
            miconexion.psPrepararSentencias= miconexion.miconexion.prepareStatement(sentenciaInsert);
            miconexion.psPrepararSentencias.setString(1, ""+micaja.getcodegreso());
