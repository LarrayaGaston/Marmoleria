 ...
 * @author fernando
 */
public class dlgMovimientoCajaegr extends javax.swing.JFrame {

    /**
     * Creates new form dlgMovimientoCajaegr
     */
    public dlgMovimientoCajaegr() {
        initComponents();
    ...
    void id(){
            ...
            String consultasql = "select max(idegreso)+1 from movimiento_cajaegr";
    ...
    private void initComponents() {
        ...
        setTitle("Movimiento de Caja Egreso");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Instancia de Metodo
        gestionarMovimientoegr guardarcaja= new gestionarMovimientoegr();

        // GUARDAR
        if(validarCampos.estaVacio(txtefectivo) && validarCampos.estaVacio(txtdescripcion))
        {
            caja.setcodegreso(codcaja.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgMovimientoCajaegr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dlgMovimientoCajaegr().setVisible(true);
            }
        });
    }
