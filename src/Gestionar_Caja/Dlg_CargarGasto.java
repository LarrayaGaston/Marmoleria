 ...
 * @author Gaston
 */
public class Dlg_CargarGasto extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_CargarGasto
     */
    public Dlg_CargarGasto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dlg_CargarGasto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dlg_CargarGasto dialog = new Dlg_CargarGasto(new javax.swing.JFrame(), true);
