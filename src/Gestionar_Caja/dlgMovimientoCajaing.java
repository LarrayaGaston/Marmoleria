...
import Metodo.gestionarMovimientoing;
 ...
 * @author fernando
 */
public class dlgMovimientoCajaing extends javax.swing.JFrame {

    /**
     * Creates new form dlgMovimientoCaja
     */
    public dlgMovimientoCajaing() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Movimiento de Caja Ingreso");
        ...
        Salir1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/door_out32.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgMovimientoCajaing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dlgMovimientoCajaing().setVisible(true);
            }
        });
    }
