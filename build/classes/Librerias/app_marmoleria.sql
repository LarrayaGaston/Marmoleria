...
-- Tiempo de generación: 12-06-2019 a las 22:29:34
...
CREATE TABLE IF NOT EXISTS `articulo` (
  `idArticulo` int(8) NOT NULL AUTO_INCREMENT,
  `detalle_articulo` varchar(30) NOT NULL,
  `codArticulo` int(11) NOT NULL,
  `idRubro` int(8) NOT NULL,
  `idMarca` int(8) NOT NULL,
  `idTipo` int(8) NOT NULL,
  `dimensionLargo` double DEFAULT NULL,
  `dimensionAlto` double DEFAULT NULL,
  `PrecioVta` double NOT NULL,
  `precioCosto` double NOT NULL,
  `precioTarjeta` double NOT NULL,
  `StockMin` int(11) NOT NULL,
  `largoBacha` varchar(50) DEFAULT NULL,
  `altoBacha` varchar(50) DEFAULT NULL,
  `anchoBacha` varchar(50) DEFAULT NULL,
  `art_impuesto` varchar(50) NOT NULL,
...
INSERT INTO `articulo` (`idArticulo`, `detalle_articulo`, `codArticulo`, `idRubro`, `idMarca`, `idTipo`, `dimensionLargo`, `dimensionAlto`, `PrecioVta`, `precioCosto`, `precioTarjeta`, `StockMin`, `largoBacha`, `altoBacha`, `anchoBacha`, `art_impuesto`, `FechaAlta`) VALUES
(1, 'z52', 326, 2, 2, 1, 1233, 2352, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(2, 'cc28', 56, 2, 11, 4, 1233, 2352, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(3, '102', 21555, 0, 0, 1, 1400, 1300, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(4, '103', 595995, 0, 0, 1, 1400, 1300, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(5, '103', 95566, 0, 0, 1, 1400, 1300, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(6, 'afgaasdf', 6556565, 2, 2, 3, 1500, 1300, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(7, '106', 6655656, 2, 2, 3, 1300, 1400, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(8, '107', 5566556, 2, 3, 3, 1400, 1300, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(9, 'aasdasf', 4534534, 1, 3, 2, 452454, 452452, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(10, 'negro boreal', 25, 1, 3, 2, 250.5, 13000, 0, 0, 0, 0, '0', '0', '0', '', NULL),
(11, 'blanco norte', 564256, 1, 5, 5, 1200, 1300, 250.5, 0, 0, 0, '0', '0', '0', '', NULL),
(12, 'azul', 564256, 1, 4, 3, 1200, 1300, 290.5, 0, 0, 0, '0', '0', '0', '', NULL),
(13, 'CC28', 4895685, 2, 11, 3, 1250, 1400, 300.5, 0, 0, 0, '0', '0', '0', '', NULL),
(14, 'VERDE', 14, 1, 1, 1, 0, 0, 500, 360, 360.5, 12, '25.4', '25.2', '56.2', '10%', NULL),
(15, 'VIOLETA', 15, 1, 1, 1, 0, 0, 6750, 320, 320.5, 23, '25.3', '45.7', '24.3', '10%', NULL),
(16, 'BLANCO NORTE', 22563, 1, 8, 10, 0, 0, 3125, 2250, 2250.5, 12, '', '', '', '21%', NULL),
(17, 'AZUL FRANCEA', 655669, 1, 8, 12, 0, 0, 4966.72, 3286.8, 3287.3, 25, '0', '0', '0', '21%', NULL),
(18, 'VERDE ESMERALDA', 2523, 1, 8, 13, 0, 0, 1875, 1350, 1350.8, 12, '25.4', '25.2', '56.2', '21%', NULL);
...
(1, 1, 5000, 10, 20, 5010, 7010, 7010, 0),
(2, 2, 8583, 122, 83, 8622, 10622, 10623, 1);
...
CREATE TABLE IF NOT EXISTS `clientes` (
  `idCliente` int(32) NOT NULL AUTO_INCREMENT,
  ...
  `cli_codpostal` int(11) NOT NULL,
  `cli_CBU` varchar(45) CHARACTER SET big5 COLLATE big5_bin DEFAULT NULL,
...
INSERT INTO `clientes` (`idCliente`, `idPersona`, `cli_razonsocial`, `cli_condiva`, `cli_telefono`, `cli_celular`, `cli_fax`, `cli_cuit`, `cli_email`, `cli_provincia`, `cli_ciudad`, `cli_direccion`, `cli_codpostal`, `cli_CBU`) VALUES
(1, 16, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 284, 'BELGRANO 123', 5641, '0'),
(2, 17, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 2, 1863, 'BELGRANO 123', 5641, '0'),
(3, 22, 'BUNGE', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 2, 146, 'BELGRANO 123', 5641, '0'),
(4, 23, 'MOLIAGROS', 3, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 285, 'BELGRANO 123', 5641, '0'),
(5, 25, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 285, 'BELGRANO 123', 5641, '2850590940090418135201'),
(6, 26, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 4, 334, 'BELGRANO 123', 5641, '2850590940090418135201'),
(7, 27, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 2, 145, 'BELGRANO 123', 5641, '2850590940090418135201'),
(8, 29, 'MUNICIPALIDAD', 4, '222232332', '322365659', 32235623, '325612665', 'MARIAJOSEPRADO@GMAIL.COM', 7, 763, 'TUPUNGATO 495', 5641, '2850590940090418135201'),
(9, 30, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 2, 146, 'BELGRANO 123', 5641, '2850590940090418135201'),
(10, 40, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 2, 147, 'BELGRANO 123', 5641, '2850590940090418135201'),
(11, 40, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 286, 'BELGRANO 123', 5641, '2850590940090418135201'),
(12, 40, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 285, 'BELGRANO 123', 5641, '2850590940090418135201'),
(13, 50, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 2, 146, 'BELGRANO 123', 5641, '2850590940090418135201'),
(14, 51, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 2, 145, 'BELGRANO 123', 5641, '2850590940090418135201'),
(15, 52, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 282, 'BELGRANO 123', 5641, '2850590940090418135201'),
(16, 53, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 4, 333, 'BELGRANO 123', 5641, '2850590940090418135201'),
(17, 56, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 4, 334, 'BELGRANO 123', 5641, '2850590940090418135201'),
(18, 56, 'LAP', 1, '222232332', '322365659', 32235623, '325612665', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 287, 'BELGRANO 123', 5641, '2850590940090418135201'),
(19, 57, 'LAP', 1, '222232332', '322365659', 32235623, '653256521', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 283, 'BELGRANO 250', 5641, '2850590940090418135201');
...
CREATE TABLE IF NOT EXISTS `detallefactura` (
  ...
  `largoP` double NOT NULL,
  `altoP` double NOT NULL,
  `M2` double NOT NULL,
  `cantidad` int(11) NOT NULL,
  `PrecioM2` decimal(8,2) NOT NULL,
...
INSERT INTO `detallefactura` (`idDetalleFactura`, `idVFactura`, `Precio`, `largoP`, `altoP`, `M2`, `cantidad`, `PrecioM2`, `codArticulo`, `idProducto`) VALUES
(1, 1, '250.50', 3.2, 1.4, 8.96, 2, '2244.48', 'Piedras', 564256),
(2, 1, '500.00', 3.2, 1.4, 13.44, 3, '6720.00', 'Piedras', 14),
(3, 1, '6750.00', 3.2, 1.6, 10.24, 2, '69120.00', 'Piedras', 15),
(4, 2, '290.50', 1.3, 1.4, 3.64, 2, '1057.42', '564256', 12),
(5, 2, '500.00', 3.2, 2.3, 14.72, 2, '7360.00', '14', 14),
(6, 2, '6750.00', 3, 1.4, 12.6, 3, '85050.00', '15', 15),
(7, 3, '500.00', 3, 1.4, 8.4, 2, '4200.00', '14', 14),
(8, 4, '500.00', 1.4, 2.3, 6.44, 2, '3220.00', '14', 14),
(9, 5, '3125.00', 1.3, 2.5, 3.25, 1, '10156.25', '22563', 16),
(10, 5, '4966.72', 2.4, 2.5, 6, 1, '29800.32', '655669', 17),
(11, 6, '4966.72', 1.4, 1.5, 4.2, 2, '20860.22', '655669', 17),
(12, 6, '6750.00', 1.4, 2.3, 6.44, 2, '43470.00', '15', 15),
(13, 6, '250.50', 1.6, 1.2, 1.92, 1, '480.96', '564256', 11),
(14, 6, '300.50', 1.6, 1.2, 5.76, 3, '1730.88', '4895685', 13),
(15, 6, '6750.00', 1.6, 1.2, 5.76, 3, '38880.00', '15', 15),
(16, 7, '3125.00', 1.4, 2.3, 6.44, 2, '20125.00', '22563', 16),
(17, 8, '6750.00', 1.4, 2.3, 6.44, 2, '43470.00', '15', 15),
(18, 8, '500.00', 1.4, 2.3, 6.44, 2, '3220.00', '14', 14),
(19, 9, '6750.00', 1.4, 2.3, 6.44, 2, '43470.00', '15', 15),
(20, 10, '250.50', 1.2, 1.4, 3.36, 2, '841.68', '564256', 11),
(21, 10, '6750.00', 1.2, 1.4, 5.04, 3, '34020.00', '15', 15),
(22, 10, '1875.00', 1.2, 1.4, 3.36, 2, '6300.00', '2523', 18),
(23, 11, '3125.00', 1.4, 2.5, 7, 2, '21875.00', '22563', 16),
(24, 11, '290.50', 1.4, 2.5, 10.5, 3, '3050.25', '564256', 12),
(25, 11, '1875.00', 1.4, 2.5, 10.5, 3, '19687.50', '2523', 18);
...
(3, 5, 1, 2, '513.1', '1026.2'),
(4, 5, 1, 2, '233.0', '466.0'),
(3, 6, 1, 2, '513.1', '1026.2'),
(7, 6, 1, 2, '323.0', '646.0'),
(2, 7, 1, 2, '270.1', '540.2'),
(6, 7, 1, 1, '86.0', '86.0'),
(11, 7, 1, 1, '42.0', '42.0'),
(8, 7, 1, 2, '325.15', '650.3'),
(2, 8, 1, 22, '270.1', '5942.200000000001');
...
CREATE TABLE IF NOT EXISTS `empleados` (
  ...
  `idPersona` int(8) NOT NULL,
  `emp_telefono` varchar(30) NOT NULL,
  `emp_celular` varchar(30) NOT NULL,
  `emp_email` varchar(30) NOT NULL,
  `emp_provincia` int(8) NOT NULL,
  `emp_ciudad` int(8) NOT NULL,
  `emp_direccion` varchar(30) NOT NULL,
  `emp_codPostal` int(8) NOT NULL,
  `emp_CBU` varchar(45) CHARACTER SET big5 COLLATE big5_bin DEFAULT NULL,
...
INSERT INTO `empleados` (`idEmpleado`, `idPersona`, `emp_telefono`, `emp_celular`, `emp_email`, `emp_provincia`, `emp_ciudad`, `emp_direccion`, `emp_codPostal`, `emp_CBU`, `emp_fecha_ingreso`) VALUES
(2, 0, '65652323', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 4, 334, 'JUJUY 456', 5641, '0', '2019-05-30'),
(3, 0, '65652323', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 2, 146, 'JUJUY 456', 5641, '0', '2019-05-30'),
(13, 31, '65652323', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 285, 'JUJUY 456', 5641, NULL, '2019-05-30'),
(14, 33, '65652323', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 287, 'JUJUY 456', 5641, NULL, '2019-05-30'),
(15, 34, '65652323', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 5, 2206, 'JUJUY 456', 5641, '2850590940090418135201', '2019-05-30'),
(16, 46, '222232332', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 5, 374, 'BELGRANO 123', 5641, '2850590940090418135201', '2019-05-30'),
(17, 47, '222232332', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 2, 146, 'BELGRANO 123', 5641, '2850590940090418135201', '2019-05-30'),
(18, 48, '222232332', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 284, 'BELGRANO 123', 5641, '2850590940090418135201', '2019-05-30'),
(19, 49, '222232332', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 5, 372, 'BELGRANO 123', 5641, '2850590940090418135201', '2019-05-30'),
(20, 54, '222232332', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 285, 'BELGRANO 123', 5641, '2850590940090418135201', '1995-03-07'),
(21, 55, '222232332', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 286, 'BELGRANO 123', 5641, '2850590940090418135201', '1995-03-07'),
(22, 58, '222232332', '322365659', 'ASDFASFDASDFASD@ADFSADFASD.COM', 3, 284, 'BELGRANO 123', 5641, '2850590940090418135201', '2019-05-30');
...
CREATE TABLE IF NOT EXISTS `marca` (
  ...
  `detalleMarca` varchar(30) DEFAULT NULL,
  `idRubro` int(8) DEFAULT NULL,
  PRIMARY KEY (`idMarca`)
...
INSERT INTO `marca` (`idMarca`, `detalleMarca`, `idRubro`) VALUES
(1, 'MARMOL', 1),
(2, 'MARMOTCH', 1),
(3, 'MARMOL', 1),
(4, 'DEKTON', 1),
...
CREATE TABLE IF NOT EXISTS `modelo` (
  `idModelo` int(8) NOT NULL AUTO_INCREMENT,
  `detalle_modelo` varchar(30) NOT NULL,
  `idRubro` int(8) NOT NULL,
...
DROP TABLE IF EXISTS `movimiento_cajaegr`;
...
(2, ' desayuno', 22, '2015-12-10'),
(3, 'Desayuno ', 22, '2015-12-17'),
(4, ' desayuno', 70, '2015-12-17'),
(5, 'desayuno ', 33, '2015-12-18'),
(6, ' desayuno', 50, '2015-12-18');
...
DROP TABLE IF EXISTS `movimiento_cajaing`;
...
(2, 'cambio ', 100, '2015-12-10'),
(3, ' Cambio', 100, '2015-12-17'),
(4, ' colaboracion de david rosso', 100, '2015-12-17'),
(5, ' coasdasdad', 100, '2015-12-17'),
(6, ' asdasdasd', 222, '2015-12-17'),
(7, ' cambio', 22, '2015-12-18'),
(8, ' cambio', 100, '2015-12-18');
...
INSERT INTO `persona` (`idPersona`, `nombre`, `apellido`, `dni`, `fechaNacimiento`) VALUES
(1, 'NICOLAS', 'LARRAYA', 3521456, NULL),
(2, 'NICOLAS', 'LARRAYA', 3521456, NULL),
(3, 'GUSTAVO', 'LARRAYA', 3521456, NULL),
(4, 'LUCAS', 'LARRAYA', 3521456, NULL),
(5, 'ROQUEE', 'LARRAYA', 3562145, NULL),
(6, 'NICOOO', 'LARRAYA', 3562145, NULL),
(7, 'LUCA', 'LARRAYA', 3562145, NULL),
(8, 'FRANCO', 'FERREYRA', 3562145, NULL),
(9, 'FRANCO', 'ACOSTA', 3562145, NULL),
(10, 'AGUTIN', 'FERREYRA', 3562145, NULL),
(11, 'MARCELO', 'FREITE', 32322323, NULL),
(12, 'MARCELO', 'LARREAAA', 32322323, NULL),
(13, 'MARCELO', 'FREITE', 32322323, NULL),
(14, 'MARCELO', 'BIZZA', 32322323, NULL),
(15, 'MARCELO', 'JUAREZ', 32322323, NULL),
(16, 'MARCELO', 'FREITE', 32322323, NULL),
(17, 'MARCELO', 'FREITE', 32322323, NULL),
(18, 'FRANCO', 'RULOS', 3521456, NULL),
(19, 'MAYCO', 'PALMIERI', 3562145, NULL),
(20, 'GASTON', 'LARRAYA', 3521456, NULL),
(21, 'PABLO', 'LARRAYA', 3521456, NULL),
(22, 'GASTON ', 'LARRAYA', 32322323, NULL),
(23, 'NANCY', 'MONZON', 17250892, NULL),
(24, 'MARCELO', 'FREITE', 32322323, NULL),
(25, 'MARCELO', 'FREITE', 32322323, NULL),
(26, 'ROSA', 'MONZON', 32322323, NULL),
(27, 'MARCELO', 'FREITE', 32322323, NULL),
(28, 'GUSTAVO', 'LARRAYA', 3562145, NULL),
(29, 'MARIA JOSE', 'PRADO', 31795095, NULL),
(30, 'DIEGO', 'RIVERO', 32322323, NULL),
(31, 'GERARDO', 'LARRAYA', 3562145, NULL),
(32, 'ENRRIQUE', 'BAEZZ', 3562145, NULL),
(33, 'ENRRIQUE', 'BAEZ', 3562145, NULL),
(34, 'ESTER', 'MONOZN', 3562145, NULL),
(35, 'FACU', 'GONZALES', 3521456, NULL),
(36, 'MARCELO', 'FREITE', 32322323, NULL),
(37, 'MARCELO', 'FREITE', 32322323, NULL),
(38, 'GUSTAVO', 'FREITE', 32322323, NULL),
(39, 'TIO', 'FREITE', 32322323, NULL),
(40, 'MARCELO', 'FREITE', 32322323, NULL),
(41, 'MARCELO', 'FREITE', 32322323, NULL),
(42, 'MARCELO', 'FREITE', 32322323, NULL),
(43, 'MARCELO', 'FREITE', 32322323, NULL),
(44, 'MARCELO', 'FREITE', 32322323, NULL),
(45, 'MARCELO', 'FREITE', 32322323, NULL),
(46, 'MARCELO', 'FREITE', 32322323, NULL),
(47, 'MARCELO', 'FREITE', 32322323, NULL),
(48, 'AGUSTIN ', 'LARRAYA', 32322323, NULL),
(49, 'AGUSTIN', 'LARRAYA', 32322323, NULL),
(50, 'GUSTAVO', 'FREITE', 32322323, NULL),
(51, 'MARCELO', 'FREITE', 32322323, NULL),
(52, 'GAS', 'LASRS', 32322323, NULL),
(53, 'MARCELO', 'FREITE', 32322323, NULL),
(54, 'MARCELO', 'FREITE', 32322323, NULL),
(55, 'GASTON', 'LARRAYA', 32322323, NULL),
(56, 'MARCELO', 'FREITE', 32322323, '1995-03-09'),
(57, 'GASTON ', 'OLOVARRIA', 38419969, '1995-03-07'),
(58, 'PEDRO', 'FREITE', 32322323, '1969-05-08'),
(59, 'GUSTAVO', 'ENRRICI', 32322323, '1988-05-12');
...
CREATE TABLE IF NOT EXISTS `proveedores` (
  ...
  `idPersona` int(8) DEFAULT NULL,
  `prov_razonSocial` varchar(30) NOT NULL,
  `prov_cuit` varchar(30) NOT NULL,
  `prov_condiva` int(8) NOT NULL,
  `prov_celular` varchar(30) NOT NULL,
  `prov_telefono` varchar(30) NOT NULL,
  `prov_fax` varchar(30) NOT NULL,
  `prov_email` varchar(30) NOT NULL,
  `prov_provincia` int(8) NOT NULL,
  `prov_ciudad` int(8) NOT NULL,
  `prov_direccion` varchar(30) NOT NULL,
  `prov_codPostal` int(8) NOT NULL,
  `prov_CBU` varchar(45) CHARACTER SET big5 COLLATE big5_bin DEFAULT NULL,
...
INSERT INTO `proveedores` (`idProveedor`, `idPersona`, `prov_razonSocial`, `prov_cuit`, `prov_condiva`, `prov_celular`, `prov_telefono`, `prov_fax`, `prov_email`, `prov_provincia`, `prov_ciudad`, `prov_direccion`, `prov_codPostal`, `prov_CBU`) VALUES
(1, 0, 'NO TENGO', '325632563', 1, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 3, 284, 'BARTOLOME MITRE 122', 3256, '0'),
(2, 0, 'NO TENGO', '325632563', 2, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 1, 4, 'BARTOLOME MITRE 122', 3256, '0'),
(3, 0, 'LA PUSE', '325632563', 2, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 2, 147, 'BARTOLOME MITRE 122', 3256, '0'),
(4, NULL, 'NO TENGO', '325632563', 1, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 4, 334, 'BARTOLOME MITRE 122', 3256, '0'),
(5, NULL, 'NO TENGO', '325632563', 2, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 4, 333, 'BARTOLOME MITRE 122', 3256, '0'),
(6, NULL, 'NO TENGO', '325632563', 1, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 3, 282, 'BARTOLOME MITRE 122', 3256, '0'),
(7, NULL, 'COSULELO', '325632563', 1, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 3, 285, 'BARTOLOME MITRE 122', 3258, '0'),
(8, 4, 'LA GILDAAA', '325632563', 1, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 2, 146, 'BARTOLOME MITRE 122', 3256, '0'),
(9, 18, 'NO TENGO', '325632563', 1, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 4, 333, 'BARTOLOME MITRE 122', 3256, '0'),
(10, 20, 'ABRASIBOS', '325632563', 1, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 2, 146, 'BARTOLOME MITRE 122', 3256, '0'),
(11, 21, 'LA TABLADA', '325632563', 1, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 2, 145, 'BARTOLOME MITRE 122', 3256, '0'),
(12, 35, 'NO TENGO', '252155692', 1, '325632632', '32562562', '32563256', 'LARRAYAGSATONNICOLAS@GAIL.COM', 3, 287, 'BARTOLOME MITRE 122', 3256, '28505909 40090418135201'),
(13, 59, 'LAP', '325612665', 1, '322365659', '222232332', '32235623', 'ASDFASFDASDFASD@ADFSADFASD.COM', 4, 333, 'BELGRANO 123', 5641, '2850590940090418135201');
...
CREATE TABLE IF NOT EXISTS `rubro` (
  ...
  `nombreRubro` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`idRubro`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
...
(6, '2015-12-17', '1672.2'),
(7, '2015-12-18', '1318.5'),
(8, '2015-12-18', '5942.200000000001');
...
CREATE TABLE IF NOT EXISTS `stock` (
  `idStock` int(8) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tipo` (
  `idTipo` int(8) NOT NULL AUTO_INCREMENT,
  `detalle_tipo` varchar(30) NOT NULL,
  `idMarca` int(8) NOT NULL,
  PRIMARY KEY (`idTipo`)
...
INSERT INTO `tipo` (`idTipo`, `detalle_tipo`, `idMarca`) VALUES
(1, 'Blancos', 5),
(2, 'Onix', 5),
(3, 'Beiges', 5),
(4, 'Marmotech', 6),
...
CREATE TABLE IF NOT EXISTS `unidad` (
  `idUnidad` int(8) NOT NULL AUTO_INCREMENT,
  `planchaEntera` int(8) NOT NULL,
  `plancha(3/4)` int(8) NOT NULL,
  `plancha(1/4)` int(8) NOT NULL,
  `plancha(1/2)` int(8) NOT NULL,
...
INSERT INTO `usuario` (`idUsuario`, `nombre`, `apellido`, `nombreUsuario`, `contraseña`, `estado`) VALUES
(1, '', '', 'larrayagaston', '123456', 'ACTIVO');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `ventafactura`
--

DROP TABLE IF EXISTS `ventafactura`;
CREATE TABLE IF NOT EXISTS `ventafactura` (
  `idVFactura` int(8) NOT NULL AUTO_INCREMENT,
  `numeroFac` varchar(50) NOT NULL,
  `idCliente` int(8) NOT NULL,
  `nombre` varchar(50) NOT NULL,
  `apellido` varchar(50) NOT NULL,
  `cli_razonsocial` varchar(50) NOT NULL,
  `cli_cuit` int(11) NOT NULL,
  ...
  PRIMARY KEY (`idVFactura`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `ventafactura`
--

INSERT INTO `ventafactura` (`idVFactura`, `numeroFac`, `idCliente`, `nombre`, `apellido`, `cli_razonsocial`, `cli_cuit`, `TotalVenta`, `Descuento`, `SubTotal`, `IVA`, `TotalPagar`, `FechaEmision`, `FechaVencimiento`, `Estado`) VALUES
(1, '000000-100', 17, 'MARCELO', 'FREITE', 'LAP', 325612665, '78084.48', '0.00', '64532.63', '13551.85', '78084.48', '2019-04-24', '2019-05-24', 'EMITIDO'),
(2, '000000-101', 17, 'MARCELO', 'FREITE', 'LAP', 325612665, '93467.42', '0.00', '77245.80', '16221.62', '93467.42', '2019-04-17', '2019-04-30', 'EMITIDO'),
(3, '000000-100', 26, 'ROSA', 'MONZON', 'LAP', 325612665, '4200.00', '0.00', '3471.07', '728.92', '4200.00', '2019-05-02', '2019-05-02', 'EMITIDO'),
(4, '000000-100', 17, 'MARCELO', 'FREITE', 'LAP', 325612665, '3220.00', '0.00', '2661.16', '558.84', '3220.00', '2019-05-13', '2019-05-13', 'EMITIDO'),
(5, '000000-101', 27, 'MARCELO', 'FREITE', 'LAP', 325612665, '39956.57', '1000.00', '32195.51', '6761.06', '38956.57', '2019-05-14', '2019-05-14', 'EMITIDO'),
(6, '000000-100', 22, 'GASTON ', 'LARRAYA', 'BUNGE', 325612665, '105422.06', '0.00', '87125.67', '18296.39', '105422.06', '2019-05-14', '2019-05-14', 'EMITIDO'),
(7, '000000-100', 30, 'DIEGO', 'RIVERO', 'LAP', 325612665, '20125.00', '0.00', '16632.23', '3492.77', '20125.00', '2019-05-20', '2019-05-20', 'EMITIDO'),
(8, '000000-105', 29, 'MARIA JOSE', 'PRADO', 'MUNICIPALIDAD', 325612665, '46690.00', '0.00', '38586.78', '8103.22', '46690.00', '2019-05-21', '2019-05-21', 'EMITIDO'),
(9, '000000-100', 25, 'MARCELO', 'FREITE', 'LAP', 325612665, '43470.00', '0.00', '35925.62', '7544.38', '43470.00', '2019-05-23', '2019-05-23', 'EMITIDO'),
(10, '000000-100', 29, 'MARIA JOSE', 'PRADO', 'MUNICIPALIDAD', 325612665, '41161.68', '0.00', '34017.92', '7143.76', '41161.68', '2019-06-07', '2019-06-07', 'EMITIDO'),
(11, '000000-100', 25, 'MARCELO', 'FREITE', 'LAP', 325612665, '44612.75', '1000.00', '36043.60', '7569.16', '43612.75', '2019-06-12', '2019-06-12', 'EMITIDO');
COMMIT;
